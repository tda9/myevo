...
public class RSAKeyUtil {
    ...
    public PrivateKey getPrivateKey() throws Exception {
        String privateKeyPEM = new String(Files.readAllBytes(Paths.get(PRIVATE_KEY_PATH))).replace("-----BEGIN PRIVATE KEY-----", "")
...
//    public static PrivateKey getPrivateKey1() throws Exception {
//        String privateKeyPEM = new String(Files.readAllBytes(Paths.get(PRIVATE_KEY_PATH))).replace("-----BEGIN PRIVATE KEY-----", "")
//        .replace("-----END PRIVATE KEY-----", "").replaceAll("\\s", "");
//        byte[] keyBytes = Base64.getDecoder().decode(privateKeyPEM);
//        PKCS8EncodedKeySpec spec = new PKCS8EncodedKeySpec(keyBytes);
...
//        System.out.println(getPrivateKey1().toString());
//    }
}
